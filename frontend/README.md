...
This directory is the **frontend** of the Civic Copilot monorepo. Run all commands below from this directory (`frontend/`). The chat UI calls the Python backend (see repo root README).
